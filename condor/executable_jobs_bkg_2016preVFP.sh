...
date
pwd
#python /nfs/dust/cms/user/gmilella/CMSSW_11_1_7/src/PhysicsTools/NanoAODTools/processors/topNNRecoNtuples.py $@ --maxEvents 500 --nosys
python /afs/desy.de/user/g/gmilella/ttx3_analysis/CMSSW_11_1_7/src/PhysicsTools/NanoAODTools/processors/ttX3.py $@ --nosys --year '2016preVFP'
date
