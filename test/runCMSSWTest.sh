function run_test()
{
    ...
    echo "==================== data ==============="
    python PhysicsTools/NanoAODTools/processors/ttX3.py --year 2017 --isData --trigger emu --input=https://github.com/ttXcubed/test-files/raw/main/nanoAODv9UL_data/MuonEG_Run2017B.root . || return 1
