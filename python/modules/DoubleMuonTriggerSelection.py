    ...
    def analyze(self, event):
        ...
        if Module.globalOptions["year"] == '2016' or Module.globalOptions["year"] == '2016preVFP':
            if Module.globalOptions["era"]=='H':
                HLT_trigFlag = event.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ or event.HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ 
            else: 
                HLT_trigFlag = event.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL or event.HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL

        if Module.globalOptions["year"] == '2017':
            if Module.globalOptions["era"]=='B':
                HLT_trigFlag = event.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ 
            else:
                HLT_trigFlag = event.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8 or event.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8
